...
# %% auto 0
__all__ = ['slice_to_coords', 'can_wcs_shift_by_int', 'get_overlap_slices', 'bkg_match']
                            ...
                            case 0:
                                ...
                                diff_img = np.pad(
                                    ...
                                    (
                                        (
                                            0,
                                            bin_[0] - diff_img.shape[0] % bin_[0],
                                        ),
                                        (
                                            0,
                                            bin_[1] - diff_img.shape[1] % bin_[1],
                                        ),
                                    ),
                                    mode="constant",
                                    constant_values=0,
                                ...
                                diff_img_rms = np.pad(
                                    ...
                                    (
                                        (
                                            0,
                                            bin_[0] - diff_img_rms.shape[0] % bin_[0],
                                        ),
                                        (
                                            0,
                                            bin_[1] - diff_img_rms.shape[1] % bin_[1],
                                        ),
                                    ),
                                    mode="constant",
