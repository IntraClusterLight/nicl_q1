...
# %% ../../nbs/euclid/xarray.ipynb #04164637-e84c-4e28-8d3c-bb436347e488
import json
import os
...
# %% ../../nbs/euclid/xarray.ipynb #027d944a-d705-447a-ac34-fb8b99050f40
...
# %% ../../nbs/euclid/xarray.ipynb #5ee9111b-4eef-4b57-9c71-63815cd4ef63
def _get_ext_type(x):
...
# %% ../../nbs/euclid/xarray.ipynb #0f9bd257
...
# %% ../../nbs/euclid/xarray.ipynb #639e1a23-ae8b-4e0a-a1c8-95ad190145a5
...
# %% ../../nbs/euclid/xarray.ipynb #dd022f71-741c-4e44-8b63-1404c8ce3fa4
...
# %% ../../nbs/euclid/xarray.ipynb #093eca4b-a1c3-484b-be4d-fcd97a1f0692
...
# %% ../../nbs/euclid/xarray.ipynb #303d7529
...
# %% ../../nbs/euclid/xarray.ipynb #8c2fc679
...
# %% ../../nbs/euclid/xarray.ipynb #58ca821e
...
# %% ../../nbs/euclid/xarray.ipynb #c7c02857
...
# %% ../../nbs/euclid/xarray.ipynb #a89a7723
...
# %% ../../nbs/euclid/xarray.ipynb #5f55b375
def xr_fast_mask(
    data,
...
# %% ../../nbs/euclid/xarray.ipynb #c58a822e
def xr_star_mask(
    bitmask,
    instrument,
):
