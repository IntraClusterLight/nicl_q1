...
# %% ../../nbs/euclid/utilities.ipynb #f5b70f5c-6847-4213-bd03-f27df088c363
import os
import re
...
# %% ../../nbs/euclid/utilities.ipynb #0bf4c8af-20f1-4c9e-9fff-8444c1ad57fd
...
# %% ../../nbs/euclid/utilities.ipynb #6084c4c8-538f-4cff-8d92-6d3386dbf980
...
# %% ../../nbs/euclid/utilities.ipynb #ad44a86c-6789-4829-aab8-d138108c3ea2
...
# %% ../../nbs/euclid/utilities.ipynb #1bde22dc-f750-45e6-8c6f-2807c98e2fac
def remove_if_necessary(path, fnglob):
    fns = Path(path).glob(fnglob)
    for fn in fns:
        os.remove(fn)

# %% ../../nbs/euclid/utilities.ipynb #7b729485-f703-4359-8f5a-7871457560d9
...
# %% ../../nbs/euclid/utilities.ipynb #5ce375e0-2170-4fdb-a105-0ada10d047ab
...
# %% ../../nbs/euclid/utilities.ipynb #dccea655-c1d3-4e27-aa39-acc8566309e9
...
# %% ../../nbs/euclid/utilities.ipynb #90aaa9ce-f036-495b-9701-6c317707b96d
...
# %% ../../nbs/euclid/utilities.ipynb #5dd10638
...
# %% ../../nbs/euclid/utilities.ipynb #a89b2b2d
