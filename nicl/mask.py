...
# %% auto 0
__all__ = ['create_bcg_mask', 'smooth_image', 'fast_mask', 'dilated_object_mask', 'create_object_mask', 'create_faint_mask',
...
def dilated_object_mask(
    ...
    if growth > 0:
        ...
        while True:
            ...
            if verbose:
                print(
                    f"seeking to grow objects with radius {size_min} pixels by {size_min * growth} pixels"
