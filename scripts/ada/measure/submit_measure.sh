...
JOB_MASK_YJH=$(sbatch --parsable --job-name=mask_${label}_YJH $measure_mask YJH)
...
JOB_PHOT_Y_YJH=$(sbatch --parsable --job-name=phot_${label}_Y_YJH --dependency=afterok:$JOB_ISO_Y $measure_phot Y --isophotes-filter YJH)
...
JOB_PHOT_J_YJH=$(sbatch --parsable --job-name=phot_${label}_J_YJH --dependency=afterok:$JOB_ISO_J $measure_phot J --isophotes-filter YJH)
...
JOB_PHOT_H_YJH=$(sbatch --parsable --job-name=phot_${label}_H_YJH --dependency=afterok:$JOB_ISO_H $measure_phot H --isophotes-filter YJH)
...
JOB_PHOT_VIS_YJH=$(sbatch --parsable --job-name=phot_${label}_VIS_YJH --dependency=afterok:$JOB_ISO_VIS $measure_phot VIS --isophotes-filter YJH)