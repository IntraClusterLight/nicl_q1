...
JOB_PHOT_Y_YJH=$(sbatch --parsable --job-name=phot_${label}_Y_YJH --dependency=afterok:$JOB_ISO_YJH:$JOB_PHOT_Y_Y measure_test_3_photometry.sh $1 Y YJH $2)
...
JOB_PHOT_J_YJH=$(sbatch --parsable --job-name=phot_${label}_J_YJH --dependency=afterok:$JOB_ISO_YJH:$JOB_PHOT_J_J measure_test_3_photometry.sh $1 J YJH $2)
...
JOB_PHOT_H_YJH=$(sbatch --parsable --job-name=phot_${label}_H_YJH --dependency=afterok:$JOB_ISO_YJH:$JOB_PHOT_H_H measure_test_3_photometry.sh $1 H YJH $2)
