...
def main():
    ...
    in_path = default_data_path("Q1_R1_processed_v0.4", "persistence")
    out_path = default_data_path("Q1_R1_clusters_v0.4", f"nina_no_bkg")
    for cluster in clusters:
        ...
        try_combine(name=cluster["Name"], cutout_cen=cutout_cen, cutout_size=cutout_size,
                    in_dir=in_path, out_dir=out_path, filters="H", bkg_sub=False)
